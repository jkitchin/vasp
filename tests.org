...
#+RESULTS:
: <ase.db.row.AtomsRow instance at 0xf964cb0>
: {u'resort': array([0, 1])}
: c (0, 1)
: {'data': {u'resort': array([0, 1])}, 'key_value_pairs': {u'running': True}, 'unique_id': u'a68628ddb95f3b52fd232abda8a86c1d'}
...
:  1| 7s|jkitchin|CO     |vasp      |-14.691|5.091|TTT|216.000| 0.000|28.010|0.041| 0.000
: Rows: 1
: Keys: running
